...
Then CVSS stands for Common Vulnerability Scoring System, it attempt to assign severity scores to vulnerabilities, allowing to ordonnance and prioritize responses and ressources according to threat. 
